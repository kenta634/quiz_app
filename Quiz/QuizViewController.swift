...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        quizArray.append(["変数を宣言するには？","func","var","class",2])
        quizArray.append(["ラベルを宣言するには？","@IBOutlet","@IBAction","@IBLabel",1])
        quizArray.append(["ボタンを宣言するには？","@IBOutlet","@IBAction","@IBButton",2])
        quizArray.append(["整数型はどれ？","Int","Double","String",1])
        quizArray.append(["関連付けの際の選択肢はどれ？","Touch Up Outside","Touch Drag Inside","Touch Up Inside",3])
        quizArray.append(["文字列型はどれ？","Int","Double","String",3])
        //------------------------ここから下にクイズを書く------------------------//
    choiceQuiz()
    }
